...
<?php
    ...
    $query1 = "select * from kipu where username='$username' or email='$email'";
    ...
    $query = "update kipu set nama='$nama', username='$username', password='$password', email='$email' where id='$id'";
